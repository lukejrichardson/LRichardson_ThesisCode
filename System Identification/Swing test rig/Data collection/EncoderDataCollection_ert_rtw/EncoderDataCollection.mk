###########################################################################
## Makefile generated for component 'EncoderDataCollection'. 
## 
## Makefile     : EncoderDataCollection.mk
## Generated on : Wed Sep 04 11:33:11 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/EncoderDataCollection.elf
...
PRODUCT_NAME              = EncoderDataCollection
MAKEFILE                  = EncoderDataCollection.mk
MATLAB_ROOT               = C:/Program Files/MATLAB/R2024a
MATLAB_BIN                = C:/Program Files/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/User/OneDrive - University of Cape Town/swing test rig/Data collection
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/User/Documents/MATLAB/R2024a/ArduinoStaticLibrary/ArduinoUno/FasterRuns
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EncoderDataCollection.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/EncoderDataCollection_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/cores/arduino -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/variants/standard -IC:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_AVR_ROOT)/tools/avr-gcc/$(AVR_GCC_LIB_VERSION)/avr/include -IC:/ProgramData/MATLAB/SupportPackages/R2024a/aCLI/user/libraries/Ethernet/src -IC:/ProgramData/MATLAB/SupportPackages/R2024a/aCLI/user/libraries/WiFi/src -IC:/ProgramData/MATLAB/SupportPackages/R2024a/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/Wire/src -IC:/ProgramData/MATLAB/SupportPackages/R2024a/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/Wire/src/utility -IC:/ProgramData/MATLAB/SupportPackages/R2024a/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/SPI/src -IC:/ProgramData/MATLAB/SupportPackages/R2024a/aCLI/user/libraries/Servo/src -IC:/ProgramData/MATLAB/SupportPackages/R2024a/aCLI/user/libraries/Servo/src/avr
...
DEFINES_STANDARD = -DMODEL=EncoderDataCollection -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ArduinoEncoder.o MW_SerialRead.o MW_SerialWrite.o xcp_ext_mode.o EncoderDataCollection.o EncoderDataCollection_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_tcp.o xcp_ext_param_default_tcp.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_tcpip.o
...
%.o : $(START_DIR)/EncoderDataCollection_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/EncoderDataCollection_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/EncoderDataCollection_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_ArduinoEncoder.o : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/MW_ArduinoEncoder.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
EncoderDataCollection.o : $(START_DIR)/EncoderDataCollection_ert_rtw/EncoderDataCollection.c
	$(CC) $(CFLAGS) -o "$@" "$<"


EncoderDataCollection_data.o : $(START_DIR)/EncoderDataCollection_ert_rtw/EncoderDataCollection_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/EncoderDataCollection_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rtiostream_tcpip.o : C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinotarget/src/rtiostream_tcpip.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

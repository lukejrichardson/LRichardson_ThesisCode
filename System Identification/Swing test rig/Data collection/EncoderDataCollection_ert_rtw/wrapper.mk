...
## Define Macros
###########################################################################
SLMKPATH=C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/staticmakefiles
MODELMK=EncoderDataCollection.mk
...
ARDUINO_SKETCHBOOK_ROOT=C:/ProgramData/MATLAB/SupportPackages/R2024a/aCLI/user/libraries
ARDUINO_BASESUPPORTPKG_ROOT=C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase
...
all : 
	...
	"$(MAKE)" -j7 -C "$(SLMKPATH)" SHELL="$(SHELL)" -f avrnetwork.mk all
